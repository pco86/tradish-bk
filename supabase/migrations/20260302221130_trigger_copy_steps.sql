...
CREATE OR REPLACE FUNCTION "public"."copy_steps_on_favorite"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
CREATE TABLE IF NOT EXISTS "public"."tradition_prep_steps" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tradition_id" "uuid" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."traditions" (
    ...
    "user_id" "uuid",
    "version" integer,
    CONSTRAINT "traditions_visibility_check" CHECK (("visibility" = ANY (ARRAY['system'::"text", 'public'::"text", 'private'::"text"]))),
    CONSTRAINT "traditions_visibility_creator_check" CHECK (((("visibility" = 'system'::"text") AND ("user_id" IS NULL)) OR (("visibility" = ANY (ARRAY['public'::"text", 'private'::"text"])) AND ("user_id" IS NOT NULL))))
);
...
CREATE TABLE IF NOT EXISTS "public"."user_steps_complete" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."user_tradition_prep_steps" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
CREATE OR REPLACE TRIGGER "copy_steps_trigger" AFTER INSERT ON "public"."user_traditions" FOR EACH ROW EXECUTE FUNCTION "public"."copy_steps_on_favorite"();



CREATE OR REPLACE TRIGGER "traditions_updated" BEFORE UPDATE ON "public"."traditions" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE POLICY "Admin can insert any traditions" ON "public"."traditions" FOR INSERT TO "service_role" WITH CHECK (true);



CREATE POLICY "Admin can update any traditions" ON "public"."traditions" FOR UPDATE TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "Creators can delete their traditions" ON "public"."traditions" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Creators can update their traditions" ON "public"."traditions" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "Tradition Prep Steps are viewable by everyone" ON "public"."tradition_prep_steps" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "Tradition selection rules" ON "public"."traditions" FOR SELECT TO "authenticated", "anon" USING ((("visibility" = ANY (ARRAY['system'::"text", 'public'::"text"])) OR (( SELECT "auth"."uid"() AS "uid") = "user_id")));



CREATE POLICY "User tradition prep completion steps are viewable by owner" ON "public"."user_steps_complete" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ("public"."user_tradition_prep_steps" "uts"
     JOIN "public"."user_traditions" "ut" ON (("ut"."id" = "uts"."user_tradition_id")))
  WHERE (("uts"."id" = "user_steps_complete"."user_step_id") AND ("ut"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))));



CREATE POLICY "User tradition prep steps are viewable by owner" ON "public"."user_tradition_prep_steps" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."user_traditions" "ut"
  WHERE (("ut"."id" = "user_tradition_prep_steps"."user_tradition_id") AND ("ut"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))));



CREATE POLICY "User traditions are viewable by owner" ON "public"."user_traditions" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Users can create user tradition prep steps" ON "public"."user_tradition_prep_steps" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."user_traditions" "ut"
  WHERE (("ut"."id" = "user_tradition_prep_steps"."user_tradition_id") AND ("ut"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))));



CREATE POLICY "Users can create user traditions" ON "public"."user_traditions" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Users can delete user tradition prep steps" ON "public"."user_tradition_prep_steps" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_traditions" "ut"
  WHERE (("ut"."id" = "user_tradition_prep_steps"."user_tradition_id") AND ("ut"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))));



CREATE POLICY "Users can delete user traditions" ON "public"."user_traditions" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Users can insert public and private traditions" ON "public"."traditions" FOR INSERT WITH CHECK ((("visibility" = ANY (ARRAY['public'::"text", 'private'::"text"])) AND (( SELECT "auth"."uid"() AS "uid") = "user_id")));



CREATE POLICY "Users can update user tradition prep steps" ON "public"."user_tradition_prep_steps" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_traditions" "ut"
  WHERE (("ut"."id" = "user_tradition_prep_steps"."user_tradition_id") AND ("ut"."user_id" = ( SELECT "auth"."uid"() AS "uid")))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."user_traditions" "ut"
  WHERE (("ut"."id" = "user_tradition_prep_steps"."user_tradition_id") AND ("ut"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))));



CREATE POLICY "Users can update user traditions" ON "public"."user_traditions" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
