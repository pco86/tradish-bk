...
CREATE TRIGGER upsert_occurrences_update_tradition AFTER UPDATE ON public.tradition_date_rules FOR EACH ROW EXECUTE FUNCTION public.excute_add_occurrences_new_tradition();
